...
// new Stop(2, 44.975392, -93.226632);  // Oak St & Washington Ave
  ...
  // CC Westbound stops
  Stop * stop_CC_WB_1 =
  new Stop(8, 44.984630, -93.186352);   // SPSC
...
new RtestPassengerGenerator (CC_WB_probs, CC_WB_stops_list);
  ...
  Route * CC_EB =
  new Route("Campus Connector - Eastbound", CC_EB_stops, CC_EB_distances,
  5, CC_EB_generator);
  Route * CC_WB =
  new Route("Campus Connector - Westbound", CC_WB_stops,
